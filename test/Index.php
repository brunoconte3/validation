        ...
        <div class="container">
            ...
            <section class="body-section-class">
                ...
                <div class="item-section-class">
                    <p>Format::convertTypes($datas, $rules)</p>
                    <div>
                        <?php
                ...
                <div class="item-section-class">
                    ...
                    <div class="class-section-code">
                        <?php
                            ...
                            echo '<b>Telefone: </b>' . Format::telephone('44999998888');  //Formata Telefone ==> (44) 99999-8888
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::identifier(\'73381209000\')</i> <br>';
                            echo '<b>CPF: </b>' . Format::identifier('73381209000');  //Formata CPF ==>  733.812.090-00
                            echo '</p>';

                            echo '</p>';
                            echo '<i>Format::companyIdentification(\'39678379000129\')</i> <br>';
                            echo '<b>CNPJ: </b>' . Format::companyIdentification('39678379000129'); //Formata CNPJ ==> 39.678.379/0001-29
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::zipCode(\'87030585\')</i> <br>';
                            echo '<b>CEP: </b>' . Format::zipCode('87030585'); //Formata CEP ==>  87030-585
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::dateBrazil(\'2020-05-12\')</i> <br>';
                            echo '<b>Data (dd/mm/yyyy): </b>' . Format::dateBrazil('2020-05-12'); //Formata Data ==>  12/05/2020
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::dateAmerican(\'12-05-2020\')</i> <br>';
                            echo '<b>Data (yyyy-mm-dd): </b>' . Format::dateAmerican('12-05-2020'); //Formata Data ==>  2020-05-12
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::currency(\'1123.45\')</i> <br>';
                            echo '<b>Moeda: </b>' . Format::currency('1123.45'); //Formata Moeda ==>  1.123,45
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::pointOnlyValue(\'1.350,45\')</i> <br>';
                            echo '<b>Moeda para gravção no BD: </b>' . Format::pointOnlyValue('1.350,45'); //Formata moeda para gravação no BD ==>  1350.45
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::onlyNumbers(\'548Abc87@\')</i> <br>';
                            echo '<b>Apenas números: </b>' . Format::onlyNumbers('548Abc87@'); //Retorna apenas números => 54887;
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::onlyLettersNumbers(\'548Abc87@\')</i> <br>';
                            echo '<b>Letras e números: </b>' . Format::onlyLettersNumbers('548Abc87@'); //Retorna apenas letras e números => 548Abc87;
                            echo '</p>';

                            //[Aplicar qualquer tipo de Mascara, aceita espaço, pontos e outros]
                            echo '<p>';
                            echo '<i>Format::mask(\'#### #### #### ####', '1234567890123456\')</i> <br>';
                            echo '<b>Máscara genérica: </b>' . Format::mask('#### #### #### ####', '1234567890123456'); //1234 5678 9012 3456
                            echo '</p>';

                            //Os format abaixo, o segundo parametro escolhe o charset, UTF-8 default
                            echo '<p>';
                            echo '<i>Format::lower(\'CArrO\')</i> <br>';
                            echo '<b>Minúsculo: </b>' . Format::lower('CArrO'); //Minusculo,  ==> carro
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::upper(\'Moto\')</i> <br>';
                            echo '<b>Maiúsculo: </b>' . Format::upper('Moto'); //Mauiusculo ==> MOTO
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::ucwordsCharset(\'aÇafrÃo maCaRRão\')</i> <br>';
                            echo '<b>Primeira letra maiúcula: </b>' . Format::ucwordsCharset('aÇafrÃo maCaRRão'); //Primeira letra maiuscula ==> Açafrão Macarrão
                            echo '</p>';

                            echo '<p>';
                            echo '<i>Format::reverse(\'Abacaxi\')</i> <br>';
                            echo '<b>String invertida: </b>' . Format::reverse('Abacaxi'); //Retorna string invertida ==> ixacabA
                            echo '</p>';
                        ?>
                    </div>
                </div>
